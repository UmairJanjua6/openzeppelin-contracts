...
contract GlocomxERC1155 is Context, AccessControl, ERC1155Burnable, ERC1155Pausable {
    
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant BURNER_ROLE = keccak256("BURNER_ROLE");
    
    event swapNftEvent(uint256, uint256, uint256, string);
    ...
    function mintBatch(
        ...
        require(hasRole(MINTER_ROLE, _msgSender()), "Must have minter role to mint");
        require(idQuantity == amounts.length, "idQuantity must be equal to _amount quantity");

        uint256[] memory ids = new uint256[](idQuantity);
